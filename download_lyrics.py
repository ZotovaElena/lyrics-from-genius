...
#make a list of groups and artists whose songs  you want to download, in this example this is (almost) all reggeaton singers
...
df222.to_csv(filename.split('.')[0]+"_all_songs.tsv", sep='\t', encoding='utf-8', index=False) #save the dataframe with all songs
